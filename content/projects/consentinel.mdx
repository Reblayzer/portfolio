...
category: "backend"
featured: true
impact: "Registers a dataset, classifies every column for personal data automatically, and routes right-to-be-forgotten requests through a stewarded workflow with an append-only audit trail."
---
